...
<main id="exp">
    <article id="bite">
        <div class="inner-wrapper grid">
            <section>
                ...
                <p><a href="/" class="cta">Make Reservations</a></p>
            </section>
    ...
    <article>
        <div class="inner-wrapper grid">
            <section>
                ...
                <p><a href="/" class="cta">Blood Types</a></p>
            </section>
    ...
    <article>
        <div class="inner-wrapper grid">
            <section>
                ...
                <p><a href="/" class="cta">On the Menu</a></p>
            </section>
    ...
    <article>
        <div class="inner-wrapper grid">
            <section>
                <h3>Restaurant</h3>
                <h2>Food & Drink for the Living</h2>
                ...
                <p><a href="/" class="cta">Contact us</a></p>
            </section>
